...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.input_lineEdit.setGeometry(QtCore.QRect(20, 20, 351, 51))
        font = QtGui.QFont()
        ...
        self.search_pushButton.setGeometry(QtCore.QRect(640, 20, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Chiller")
        ...
        self.textEdit.setGeometry(QtCore.QRect(20, 80, 761, 491))
        font = QtGui.QFont()
        font.setFamily("方正舒体")
    ...
    def retranslateUi(self, Form):
        ...
        self.input_lineEdit.setText(_translate("Form", " input a word..."))
